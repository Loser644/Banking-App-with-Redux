...
export default function SginEl({statep}) {
        ...
        <div className="sginUPdiv">
            <div className="formDiv">
                <form action="" onSubmit={handleSubmit} >
                    ...
                    <div className="inputDiv">
                        <input  onBlur={(e)=>handleBlur(e.target)} name="Password" type={showPass ? 'text' : 'password'} id="Password" />
                ...
                <button onClick={()=>statep(prev=>({
                    ...prev,
                    login:true,
                    sginup:false
                }))} className="l-acout">Login</button>
            </div>
        </div>
    )
}